[![Build Status](https://travis-ci.com/lambrioanpm/ullam-sequi-excepturi.svg?branch=main)](https://travis-ci.com/lambrioanpm/ullam-sequi-excepturi)
...
[![Maintainability](https://api.codeclimate.com/v1/badges/31071476c2117e90d6fe/maintainability)](https://codeclimate.com/github/lambrioanpm/ullam-sequi-excepturi/maintainability)
[![Test Coverage](https://api.codeclimate.com/v1/badges/31071476c2117e90d6fe/test_coverage)](https://codeclimate.com/github/lambrioanpm/ullam-sequi-excepturi/test_coverage)
...
Install it using npm: `npm install @lambrioanpm/ullam-sequi-excepturi`

If used in a browser environment, you will need to manually install the local you wish to support.

```javascript
var languages = require("@lambrioanpm/ullam-sequi-excepturi");

// Support german & english languages.
languages.registerLocale(require("@lambrioanpm/ullam-sequi-excepturi/langs/en.json"));
languages.registerLocale(require("@lambrioanpm/ullam-sequi-excepturi/langs/de.json"));
```
